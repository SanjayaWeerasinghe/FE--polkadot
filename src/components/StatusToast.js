  ...
  const getToastConfig = (type) => {
    const configs = {
      success: {
        ...
        progressColor: 'bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500',
      ...
      error: {
        ...
        progressColor: 'bg-gradient-to-r from-red-500 via-rose-500 to-pink-500',
      ...
      warning: {
        ...
        progressColor: 'bg-gradient-to-r from-amber-500 via-yellow-500 to-orange-500',
      ...
      loading: {
        ...
        progressColor: 'bg-gradient-to-r from-violet-500 via-purple-500 to-indigo-500',
